...
SECTIONS
{
   ...
   /* Keep .text contiguous across adjacent banks. */
   .text               : >> FLASHB | FLASHC | FLASHD | FLASHE,  PAGE = 0, ALIGN(8)

   /* Move “init” sections out of FLASHB to free space for .text */
#if defined(__TI_EABI__)
   .init_array         : > FLASHE,      PAGE = 0, ALIGN(8)
...
#if defined(__TI_EABI__)
   .bss                : > RAMLS5       PAGE = 1
   .bss:output         : > RAMLS3       PAGE = 1  /* moved to PAGE 1 */
   ...
   /* --- RAM functions (copy from Flash E to RAM at boot) --- */
