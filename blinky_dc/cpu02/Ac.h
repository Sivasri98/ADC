...
float v_out_alpha_1=1.59860766,v_out_alpha_2=1.55661523,v_out_beta_1=1538.461538,v_out_beta_2=392.1568628;
...
float  duty_err=0,duty_err_pre=0,duty_out_alpha=0,duty_out_alpha_pre=0,duty_out_beta=0,
        duty_out_beta_pre=0,duty_in=0,kr_d=0.8,duty_out=0,kp_r=0.1,kr_r=0;
